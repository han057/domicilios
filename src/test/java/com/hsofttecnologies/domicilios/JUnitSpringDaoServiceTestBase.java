 ...
 * server over and over again, which is too time wastage.<BR/>
...
@ContextConfiguration(classes = { SpringContextTestConfig.class,
		HibernateTestConfig.class })
@Ignore
public abstract class JUnitSpringDaoServiceTestBase {

	public JUnitSpringDaoServiceTestBase() {
