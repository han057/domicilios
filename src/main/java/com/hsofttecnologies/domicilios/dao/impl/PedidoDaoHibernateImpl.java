...
public class PedidoDaoHibernateImpl extends AbstractDAO<Pedido> implements PedidoDao {
	...
	/* (non-Javadoc)
	 * @see com.hsofttecnologies.domicilios.dao.PedidoDao#buscarPorNombre(java.lang.String)
	 */
	public Pedido buscarPorNombre(String clienteNombre) {
		logger.debug("Buscar pedido por Nombre de  Clienet: "+clienteNombre);
		return (Pedido) getSession().createCriteria(Pedido.class).add(Restrictions.eq("clienteNombre", clienteNombre)).uniqueResult();
	}

	/* (non-Javadoc)
	 * @see com.hsofttecnologies.domicilios.dao.PedidoDao#agregarPedido(com.hsofttecnologies.domicilios.entities.Pedido)
	 */
	...
	/* (non-Javadoc)
	 * @see com.hsofttecnologies.domicilios.dao.PedidoDao#actualizarPedido(com.hsofttecnologies.domicilios.entities.Pedido)
	 */
